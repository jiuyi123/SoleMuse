...
SoleMuse 是面向鞋履及相关品类设计师的 AI 创意作品展示与交流平台。

当前阶段仅开发原生 JavaScript 微信小程序前端，工程骨架已经初始化。Node.js API 与 Web 端将在后续阶段接入，并共用同一套业务接口。
...
- 小程序工作区：[apps/wechat-miniapp/README.md](apps/wechat-miniapp/README.md)
- AI 开发约束：[AGENTS.md](AGENTS.md)
- 项目技能：[.agents/skills/solemuse-miniapp/SKILL.md](.agents/skills/solemuse-miniapp/SKILL.md)

## 当前范围

- 微信小程序：当前开发范围
- Node.js API：仅预留接口边界，暂不实现
- Web：暂不实现
